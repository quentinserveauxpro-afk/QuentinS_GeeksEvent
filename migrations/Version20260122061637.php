 ...
 */
final class Version20260122061637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, telephone VARCHAR(20) DEFAULT NULL, type VARCHAR(255) NOT NULL, siret VARCHAR(14) DEFAULT NULL, nom_de_scene VARCHAR(50) DEFAULT NULL, pseudo VARCHAR(50) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, date_de_naissance DATE DEFAULT NULL, PRIMARY KEY (id))');
